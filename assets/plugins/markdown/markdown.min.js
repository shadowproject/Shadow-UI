  ...
  parse: function (str, strict) {
    ...
    while ((stra = micromarkdown.regexobject.links.exec(str)) !== null) {
      if (stra[0].substr(0, 1) === '!') {
        str = str.replace(stra[0], '<img src="file:////opt/shadow/assets/img/shadow_logo.png" onclick="confirmConversationShowImage(this)" data-src="' + stra[2] + '" alt="' + stra[1] + '" title="' + stra[1] + '" />\n');
      } else {
